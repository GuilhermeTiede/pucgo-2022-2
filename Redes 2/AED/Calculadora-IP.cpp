...
string decimal_para_binario(int);//
string CIDR(int);//

int binaryToDecimal(string, int);

int binario_para_decimal(string,int);//

int *ip_mask_integers(string);

int *mascara_ip_inteiros(string);//

int *brodcastGenerater(int *, int *);

int *gerador_broadcast(int *,int *);//

int *networkGenerater(int *, int *);

int *gerador_rede(int *, int *);//

string classType(int *);

string classe_endereco(int *);//

int *maskGenerater(int *, int);

int *gerador_mascara(int *, int);//
