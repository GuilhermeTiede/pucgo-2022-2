...
#define DIVE ((rpc_uint)4)
extern "C" double * dive_1(operands *, CLIENT *);
extern "C" double * dive_1_svc(operands *, struct svc_req *);
...
#define DIVE ((rpc_uint)4)
extern  double * dive_1(operands *, CLIENT *);
extern  double * dive_1_svc(operands *, struct svc_req *);
...
#define DIVE ((rpc_uint)4)
extern  double * dive_1();
extern  double * dive_1_svc();
#endif /* Old Style C */
